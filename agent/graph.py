...
Flow (Phase 6 scope — grounding gate, confidence, citations, and guardrails
are added in later phases and will extend this graph after collect_evidence):

    START -> validate_scope --[in scope]--> plan_research --> route_tools --> {retrieve_*} --> collect_evidence -> END
